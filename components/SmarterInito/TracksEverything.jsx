...
const TracksEverything = () => {
  ...
  return (
    <div className="bg-white max-w-[900px] mx-auto md:rounded-3xl md:mt-20">
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="p-14 md:p-10 md:order-1">
          <p className="text-[#112D35] text-3xl font-bold">
          ...
          <div className="text-[#112D35] font-medium mt-5">
